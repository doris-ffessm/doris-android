...
public class RechercheParNom {
	...
	RechercheParNom() {
		if (LOG) Log.d(TAG, "RechercheParNom()- Début");

    	if (LOG) Log.d(TAG, "RechercheParNom()- Fin");
	}
    ...
    public void getPage(String inUrl, String inMot, boolean inSuivant, int inNumPageSuite) throws ClientProtocolException, IOException{
