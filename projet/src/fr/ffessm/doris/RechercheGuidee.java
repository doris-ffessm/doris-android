...
public class RechercheGuidee {
	...
	RechercheGuidee(){
		if (LOG) Log.d(TAG, "RechercheGuidee()- Début");
		
		if (LOG) Log.d(TAG, "RechercheGuidee()- Fin");
	}
    ...
    public void getPageGrandsGroupes(SharedPreferences inPreferences) throws ClientProtocolException, IOException{
    ...
    public void getGroupes(){
    	...
    	groupe = new Groupe(appContext, 0, 0, "");
    	nivPrecedent = 0;
