...
public class Groupe {
	...
	public static final String XML_REF_GOUPEFILS = "goupeFils";
...
C'est ce texte. */ 
	...
	/** Permet de créer ou lire l'arborescence des groupes par récurrence */ 
	public Groupe getGoupeFils() {
		return this.goupeFils;
	}
	public void setGoupeFils(Groupe goupeFils) {
		this.goupeFils = goupeFils;
	}			
	public Groupe getGroupePere() {
		// Start of user code placeholder for derived referenc groupePere
		// End of user code
	...
	public String toXML(String indent, DorisDBHelper contextDB){
		...
		if(this.goupeFils!= null){
			sb.append("\n"+indent+"\t<"+XML_REF_GOUPEFILS+">");
			sb.append(this.goupeFils);
	    	sb.append("</"+XML_REF_GOUPEFILS+">");
		}
