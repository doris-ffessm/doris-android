...
public class ParticipantXMLParser extends DefaultHandler{
    ...
    private StringBuilder content;
 	...
 	public ParticipantXMLParser(XMLReader reader, DefaultHandler parentHandler) {
        this.reader = reader;
    ...
    public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
		if(name.equals(Participant.XML_PARTICIPANT)){
    ...
    public void endElement(String uri, String localName, String name) throws SAXException {
		...
		else if (name.equals(Participant.XML_ATT_NOM)) {
			this.currentParticipant.setNom(content.toString());
    	}
