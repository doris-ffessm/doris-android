...
public class Image {
     ...
     */
    public Image(String type, String identifier, String value, int id, int classattributeId) {
        this.type = type;
    ...
    public Image withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public Image withClassattributeId(int classattributeId) {
        this.classattributeId = classattributeId;
        return this;
    }
