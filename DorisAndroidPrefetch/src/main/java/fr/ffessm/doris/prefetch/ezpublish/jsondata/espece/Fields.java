...
@JsonPropertyOrder({
    ...
    "display_home_date",
    "distribution",
    "is_open_for_main_writer",
    "is_open_for_correction"
})
public class Fields {
    ...
    @JsonProperty("is_open_for_main_writer")
    private IsOpenForMainWriter isOpenForMainWriter;
    @JsonProperty("is_open_for_correction")
    private IsOpenForCorrection isOpenForCorrection;
    @JsonIgnore
     ...
     */
    @JsonProperty("espece")
    public void setEspece(Espece_ espece) {
        this.espece = espece;
    }
     ...
     * 
     * @return
     *     The isOpenForMainWriter
     */
    @JsonProperty("is_open_for_main_writer")
    public IsOpenForMainWriter getIsOpenForMainWriter() {
        return isOpenForMainWriter;
    }

    /**
     * 
     * @param isOpenForMainWriter
     *     The is_open_for_main_writer
     */
    @JsonProperty("is_open_for_main_writer")
    public void setIsOpenForMainWriter(IsOpenForMainWriter isOpenForMainWriter) {
        this.isOpenForMainWriter = isOpenForMainWriter;
    }

    /**
     * 
     * @return
     *     The isOpenForCorrection
     */
    @JsonProperty("is_open_for_correction")
    public IsOpenForCorrection getIsOpenForCorrection() {
        return isOpenForCorrection;
    }

    /**
     * 
     * @param isOpenForCorrection
     *     The is_open_for_correction
     */
    @JsonProperty("is_open_for_correction")
    public void setIsOpenForCorrection(IsOpenForCorrection isOpenForCorrection) {
