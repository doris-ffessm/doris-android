...
public class Reference {
     ...
     */
    public Reference(String type, String identifier, String value, int id, int classattributeId) {
        this.type = type;
    ...
    public Reference withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public Reference withId(int id) {
        this.id = id;
        return this;
    }
    ...
    public Reference withClassattributeId(int classattributeId) {
        this.classattributeId = classattributeId;
        return this;
    }
