...
public class Country {
     ...
     */
    public Country(String type, String identifier, String value, int id, int classattributeId) {
        this.type = type;
    ...
    public Country withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public Country withClassattributeId(int classattributeId) {
        this.classattributeId = classattributeId;
        return this;
    }
