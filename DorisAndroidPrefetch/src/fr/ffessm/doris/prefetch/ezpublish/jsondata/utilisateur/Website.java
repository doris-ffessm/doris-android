...
public class Website {
     ...
     */
    public Website(String type, String identifier, String value, int id, int classattributeId) {
        this.type = type;
    ...
    public Website withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Website withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public Website withClassattributeId(int classattributeId) {
        this.classattributeId = classattributeId;
        return this;
    }
    ...
    public Website withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
