...
public class Description {
     ...
     */
    public Description(String type, String identifier, String value, int id, int classattributeId) {
        this.type = type;
    ...
    public Description withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public Description withId(int id) {
        this.id = id;
        return this;
    }
    ...
    public Description withClassattributeId(int classattributeId) {
        this.classattributeId = classattributeId;
        return this;
    }
