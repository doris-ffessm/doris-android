...
public class Address {
     ...
     */
    public Address(String type, String identifier, String value, int id, int classattributeId) {
        this.type = type;
    ...
    public Address withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public Address withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public Address withClassattributeId(int classattributeId) {
        this.classattributeId = classattributeId;
        return this;
    }
