...
public class ListeImageGroupeAvecFiltre_ClassListViewActivity extends OrmLiteActionBarActivity<OrmLiteDBHelper> implements OnItemClickListener, ActivityWithIndexBar {
    ...
    ListeImageGroupeAvecFiltre_Adapter adapter;
    ...
    public void onCreate(Bundle bundle) {
        ...
        ListView list = findViewById(R.id.listeimagegroupeavecfiltre_listview);
        list.setClickable(true);

        Log.d(LOG_TAG, "ListeImageGroupeAvecFiltre_ClassListViewActivity - onCreate");

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        adapter = new ListeImageGroupeAvecFiltre_Adapter(this, getHelper().getDorisDBHelper(),
    ...
    protected void onResume() {
        ...
        Log.d(LOG_TAG, "ListeImageGroupeAvecFiltre_ClassListViewActivity - onResume");
        ...
        ListeImageGroupeAvecFiltre_ClassListViewActivity.this.adapter.refreshFilter();
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
    ...
    private void handleIntent(Intent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(intent.getAction())) {
            ...
            ListeImageGroupeAvecFiltre_ClassListViewActivity.this.adapter.getFilter().filter(query);
        }
    }
    ...
    public void onItemClick(AdapterView<?> arg0, View view, int position, long index) {
        ...
        if (view instanceof LinearLayout && view.getId() == R.id.listeimagegroupeavecfiltre_listviewrow) {
            //Start of user code onItemClick additions ListeImageGroupeAvecFiltre_ClassListViewActivity
            ...
            if(rowview.getTag() !=  null && rowview.getTag() instanceof Groupe) {
                ...
                if (newPosition != null) {
                    ...
                    ListView listview = findViewById(R.id.listeimagegroupeavecfiltre_listview);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String arg0) {
                ...
                ListeImageGroupeAvecFiltre_ClassListViewActivity.this.adapter.getFilter().filter(arg0);
                return false;
            }
        });
    ...
    public ListView getAlphabetListView() {
        return findViewById(R.id.listeimagegroupeavecfiltre_listView_alphabets);
    }
    ...
    public void updateFilterInActionBar() {
        ...
        if ((prefs.getInt(getString(R.string.pref_key_filtre_groupe), groupRootId) != groupRootId) ||
            ...
            if (searchButtonMenuItem != null)
                searchButtonMenuItem.setIcon(ThemeUtil.attrToResId(((ListeImageGroupeAvecFiltre_ClassListViewActivity) context), R.attr.ic_app_filter_settings_actif));
        } else {
            // pas de filtre actif
    ...
    public void showPopup() {
        ...
        if (menuItemView != null) {
            ...
            View containerView = findViewById(R.id.listeimagegroupeavecfiltre_listview);
        ...
        btnFiltreEspece.setOnClickListener(v -> {
            ...
            Intent toGroupeSelectionView = new Intent(ListeImageGroupeAvecFiltre_ClassListViewActivity.this, GroupeSelection_ClassListViewActivity.class);
            Bundle b = new Bundle();
        ...
        int currentFilterId = prefs.getInt(ListeImageGroupeAvecFiltre_ClassListViewActivity.this.getString(R.string.pref_key_filtre_zonegeo), -1);
        ...
        btnZoneGeo.setOnClickListener(v -> {
            ...
            startActivity(new Intent(ListeImageGroupeAvecFiltre_ClassListViewActivity.this, ZoneGeoSelection_ClassListViewActivity.class));
        });
