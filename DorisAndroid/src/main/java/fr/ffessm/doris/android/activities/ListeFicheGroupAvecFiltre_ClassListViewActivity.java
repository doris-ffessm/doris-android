...
/**
 * Display the Fiche sorted by Doris Group
 */

public class ListeFicheGroupAvecFiltre_ClassListViewActivity extends OrmLiteActionBarActivity<OrmLiteDBHelper> implements OnItemClickListener, ActivityWithIndexBar {

    private static final String LOG_TAG = ListeFicheGroupAvecFiltre_ClassListViewActivity.class.getSimpleName();
    ...
    ListeFicheGroupAvecFiltre_Adapter adapter;
    ...
    public void onCreate(Bundle bundle) {
        ...
        Log.d(LOG_TAG, "ListeFicheGroupAvecFiltre_ClassListViewActivity - onCreate");

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        adapter = new ListeFicheGroupAvecFiltre_Adapter(this, getHelper().getDorisDBHelper(), prefs.getInt(getString(R.string.pref_key_filtre_zonegeo), -1));
    ...
    protected void onResume() {
        ...
        ListeFicheGroupAvecFiltre_ClassListViewActivity.this.adapter.refreshFilter();
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);

        Log.d(LOG_TAG, "ListeFicheGroupAvecFiltre_ClassListViewActivity - pref_key_list_icone_taille : " + context.getString(R.string.pref_key_list_icone_taille));
        Log.d(LOG_TAG, "ListeFicheGroupAvecFiltre_ClassListViewActivity - list_icone_taille_defaut : " + context.getString(R.string.list_icone_taille_defaut));
        Log.d(LOG_TAG, "ListeFicheGroupAvecFiltre_ClassListViewActivity - list_icone_taille_defaut : " + Integer.parseInt(context.getString(R.string.list_icone_taille_defaut)));
        Log.d(LOG_TAG, "ListeFicheGroupAvecFiltre_ClassListViewActivity - test : " + paramOutils.getParamInt(R.string.pref_key_list_icone_taille,
    ...
    private void handleIntent(Intent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(intent.getAction())) {
            ...
            ListeFicheGroupAvecFiltre_ClassListViewActivity.this.adapter.getFilter().filter(query);
        }
    }
    ...
    public void onItemClick(AdapterView<?> arg0, View view, int position, long index) {
        ...
        if (view instanceof LinearLayout && view.getId() == R.id.listefichegroupavecfiltre_listviewrow) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String arg0) {
                ...
                ListeFicheGroupAvecFiltre_ClassListViewActivity.this.adapter.getFilter().filter(arg0);
                return false;
            }
        });
    ...
    public void updateFilterInActionBar() {
        ...
        if ((prefs.getInt(getString(R.string.pref_key_filtre_groupe), groupRootId) != groupRootId) ||
            ...
            if (searchButtonMenuItem != null)
                searchButtonMenuItem.setIcon(ThemeUtil.attrToResId(((ListeFicheGroupAvecFiltre_ClassListViewActivity) context), R.attr.ic_app_filter_settings_actif));
        } else {
            // pas de filtre actif
            // remet l'imaged efiltre inactif
            //searchButton.setImageResource(R.drawable.filter_settings_32);
            if (searchButtonMenuItem != null)
                searchButtonMenuItem.setIcon(ThemeUtil.attrToResId(((ListeFicheGroupAvecFiltre_ClassListViewActivity) context), R.attr.ic_app_filter_settings));
    ...
    public void showPopup() {
        ...
        btnFiltreEspece.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent toGroupeSelectionView = new Intent(ListeFicheGroupAvecFiltre_ClassListViewActivity.this, GroupeSelection_ClassListViewActivity.class);
                Bundle b = new Bundle();
        ...
        int currentFilterId = prefs.getInt(ListeFicheGroupAvecFiltre_ClassListViewActivity.this.getString(R.string.pref_key_filtre_zonegeo), -1);
        ...
        btnZoneGeo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ListeFicheGroupAvecFiltre_ClassListViewActivity.this, ZoneGeoSelection_ClassListViewActivity.class));
            }
        });
