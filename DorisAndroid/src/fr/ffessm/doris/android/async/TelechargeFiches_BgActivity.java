...
// Start of user code additional imports TelechargeFiches_BgActivity
import fr.ffessm.doris.android.datamodel.Fiche;
// End of user code

public class TelechargeFiches_BgActivity  extends AsyncTask<String,Integer, Integer>{
	private static final String LOG_TAG = TelechargeFiches_BgActivity.class.getCanonicalName();
    ...
    // Start of user code additional attribute declarations TelechargeFiches_BgActivity
	// End of user code
    
	/** constructor */
    public TelechargeFiches_BgActivity(Context context, OrmLiteDBHelper dbHelper){
		// Start of user code additional attribute declarations TelechargeFiches_BgActivity constructor
		String initialTickerText = context.getString(R.string.telechargefiches_bg_initialTickerText);
    ...
    protected Integer doInBackground(String... arg0) {
		...
		// Start of user code initialization of the task TelechargeFiches_BgActivity
    	...
    	// Start of user code main loop of task TelechargeFiches_BgActivity
		...
		// Start of user code end of task TelechargeFiches_BgActivity
	...
	protected void onCancelled() {
		...
		// Start of user code TelechargeFiches onCancelled
		// End of user code
	}
    ...
    // Start of user code additional operations TelechargeFiches_BgActivity
