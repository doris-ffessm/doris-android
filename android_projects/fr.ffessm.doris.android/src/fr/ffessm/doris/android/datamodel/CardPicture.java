...
@DatabaseTable(tableName = "cardPicture")
public class CardPicture {

	public static final String XML_CARDPICTURE = "CARDPICTURE";
	...
	// Start of user code CardPicture additional properties
	// End of user code
	
	public CardPicture() {}// needed by ormlite
	public CardPicture(java.lang.String pictureFileName, java.lang.String title, java.lang.String description) {
		super();
